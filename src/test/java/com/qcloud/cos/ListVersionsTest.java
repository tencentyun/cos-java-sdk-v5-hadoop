    ...
    public void putTestFile(boolean retVersionFlag) throws Exception {
        for (int i = 0; i < fileNum; ++i) {
            for (int j = 0; j < eachFileVersionNum; ++j) {
                ...
                System.out.println("upload key: " + key + ", localFileIndex: " + localFileIndex
                        + ", localFile: " + localFile.getAbsolutePath() + ", etag: "
    ...
    public void testListVersionsForEnabledVersions() throws Exception {
        ...
        while (true) {
            ...
            for (COSVersionSummary versionInfo : versionSummaries) {
                ...
                // System.out.println("keyIndex: " + keyIndex + ", localFileIndex: " +
                // localFileIndex
                // + ", localFile: " + localFileArray[keyIndex].getAbsolutePath());
                System.out.println("key: " + versionInfo.getKey() + ", versionId: "
                        + versionInfo.getVersionId() + ",  size: " + versionInfo.getSize()
                        + ", Etag: " + versionInfo.getETag() + ", isDeleteMarker:"
                        + (versionInfo.isDeleteMarker() ? "true" : "false"));
