...
public class DefaultCosHttpClient implements CosHttpClient {
    ...
    private void initHttpClient() {
        ...
        connectionManager.setMaxTotal(this.clientConfig.getMaxConnectionsCount());
        connectionManager.setDefaultMaxPerRoute(this.clientConfig.getMaxConnectionsCount());
        this.httpClient = new DefaultHttpClient(connectionManager);
        HttpParams httpParams = this.httpClient.getParams();
        HttpConnectionParams.setConnectionTimeout(httpParams, this.clientConfig.getConnectionTimeout());
        HttpConnectionParams.setSoTimeout(httpParams, this.clientConfig.getSocketTimeout());
